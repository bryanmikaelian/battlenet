var client = (function () {
  ...
  return {
    data: {
      ...
      // Currently returns a 404 if no trailing slash
      ...
      races: function (region, callback) {
        var options = {
          host: "http://" + region + ".battle.net",
          query: {},
          path: "api/wow/data/character/races"
        };
        get(options, function (data) {
          callback(data.races);
        });
      ...
      achievements: function (region, callback) {
        var options = {
          host: "http://" + region + ".battle.net",
          query: {},
          path: "api/wow/data/character/achievements"
        };
        get(options, function (data) {
      ...
      guildRewards: function (region, callback) {
        var options = {
          host: "http://" + region + ".battle.net",
          query: {},
          path: "api/wow/data/guild/rewards"
        };
        get(options, function (data) {
      ...
      guildPerks: function (region, callback) {
        var options = {
          host: "http://" + region + ".battle.net",
          query: {},
          path: "api/wow/data/guild/perks"
        };
        get(options, function (data) {
          callback(data.perks);
        });
      ...
      guildAchievements: function (region, callback) {
        var options = {
          host: "http://" + region + ".battle.net",
          query: {},
          path: "api/wow/data/guild/achievements"
        };
        get(options, function (data) {
          callback(data.achievements);
        });
      ...
      itemClasses: function (region, callback) {
        var options = {
          host: "http://" + region + ".battle.net",
          query: {},
          path: "api/wow/data/item/classes"
        };
        get(options, function (data) {
          callback(data.classes);
        });
    ...
    recipe: function (recipe, callback) {
      var options = {
        host: "http://" + recipe.region + ".battle.net",
        query: {},
        path: "/api/wow/recipe/" + recipe.id
      };
      get(options, function (data) {
        callback(data);
      });
